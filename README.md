...
- 👤 **Reactive profiles** — Live profile loading via applesauce-core EventStore + ProfileModel
...
- 📖 **Stories** — Ephemeral story-style posts (kind 30509)
- 🔔 **Notifications** — Mentions, reactions, zaps, reposts, and new followers

### Settings
- 📡 **Relay management** — Add, remove, and reset your relay list
- ⚡ **Wallet settings** — Connect/disconnect NWC wallet, set default zap amount
...
- **applesauce-core** — EventStore + ProfileModel for reactive profile data
- **applesauce-react** — `use$` hook for subscribing to observable profile state
...
Connect a NWC-compatible wallet for instant one-tap zapping without leaving the app. Tap **Connect Wallet** in the sidebar or under Settings in your profile and paste your `nostr+walletconnect://` URI.

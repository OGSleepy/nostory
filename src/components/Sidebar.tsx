...
import { Home, Compass, PlusSquare, MessageCircle, User, Play, Bell, Bookmark, LogOut } from 'lucide-react';

export const Sidebar: React.FC = () => {
  const { activeTab, setActiveTab, profile, isAuthenticated, logout, notifications } = useNostrStore();
